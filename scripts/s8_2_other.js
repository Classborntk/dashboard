var url = 'http://classborn.byethost7.com/php/geturl.php?urlpage=https://chasing-coins.com/api/v1/std/marketcap';
var url2 = 'http://classborn.byethost7.com/php/geturl.php?urlpage=https://chasing-coins.com/api/v1/top-coins/5';
var iframe;
var smarket_cap;
var schange;
var s24;
...
function listenMessage(msg) {    
    ...
    /* chasing-coins.com parse */
    if (json.market_cap) {
        smarket_cap = json.market_cap;
        schange = json.change;
        s24 = schange['24h'];
        s1 = schange['1h'];
        s7 = schange['7d'];
        s24h_volume = json['24h_volume'];
        loadcontents();
    } else {
        var data = [];
